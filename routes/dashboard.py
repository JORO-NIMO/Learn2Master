"""routes/dashboard.py — General dashboard route (Supabase/PostgreSQL edition)."""
    ...
    try:
        ...
        if selected_subject_id:
            ...
            cur.execute("""
                ...
                FROM courses WHERE subject_id = %s ORDER BY course_title
            """, (selected_subject_id,))
        ...
        if selected_course_id:
            ...
            cur.execute("""
                ...
                LEFT JOIN mastery_records
                    ...
                    AND mastery_records.learner_id = %s
                WHERE lessons.course_id = %s
                ORDER BY lessons.sequence_order
            """, (learner_id, selected_course_id))
